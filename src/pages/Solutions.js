...
function Solutions() {
  ...
  // EyeIcon for Iris — hidden for now

  return (
    <div className="page">
      {/* Styles */}
      <style>{`
        /* hero-image-desktop hidden on mobile is handled by hero.css */
      ...
      <section className="page-hero">
        <div>
          ...
          <p className="section-description" style={{ maxWidth: "520px" }}>
          ...
          <div className="hero-image-mobile">
            <video
              ...
              loop
              playsInline
              aria-label="Archv platform demonstration"
            >
      ...
      <section>
        ...
        >
          <button
            role="tab"
            id="tab-ink"
            aria-selected={activeTab === "ink"}
            aria-controls="tabpanel-ink"
          ...
          {/* Iris tab hidden for now */}
        </div>

        {/* Ink Content */}
        {activeTab === "ink" && (
          <div className="tab-content" key="ink" role="tabpanel" id="tabpanel-ink" aria-labelledby="tab-ink">
            <div
              style={{
